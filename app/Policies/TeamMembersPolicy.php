...
class TeamMembersPolicy
{
    ...
    {
        return $user->can('view_any_team::members');
    }
    ...
    {
        return $user->can('view_team::members');
    }
    ...
    {
        return $user->can('create_team::members');
    }
    ...
    {
        return $user->can('update_team::members');
    }
    ...
    {
        return $user->can('delete_team::members');
    }
    ...
    {
        return $user->can('delete_any_team::members');
    }
     ...
     */
    public function replicate(User $user, TeamMembers $teamMembers): bool
    {
