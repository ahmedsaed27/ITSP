...
class EmployeeReviewPolicy
{
    ...
    {
        return $user->can('view_any_employee::review');
    }
    ...
    {
        return $user->can('view_employee::review');
    }
    ...
    {
        return $user->can('create_employee::review');
    }
    ...
    {
        return $user->can('update_employee::review');
    }
    ...
    {
        return $user->can('delete_employee::review');
    }
    ...
    {
        return $user->can('delete_any_employee::review');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, EmployeeReview $employeeReview): bool
    {
